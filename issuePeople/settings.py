"""
Django settings for issuePeople project.
...
LOGOUT_REDIRECT_URL = '/usuaris/login/'
...
ROOT_URLCONF = 'issuePeople.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'issuePeople/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'issuePeople.wsgi.application'
...
DEFAULT_FILE_STORAGE = 'issuePeople.storage_backends.MediaStorage'
